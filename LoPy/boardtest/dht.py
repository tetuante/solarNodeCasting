...
class DHT:
    ...
    #__dataPin = Pin('P3', mode=Pin.OPEN_DRAIN)
    __dhttype = 0

    def __init__(self, dataPin, sensor=0):
        self.__dataPin = Pin(dataPin, mode=Pin.OPEN_DRAIN, pull=Pin.PULL_UP)
    ...
    def read(self):
        ...
        data = pycom.pulses_get(self.__dataPin,100)
        self.__dataPin.init(Pin.OPEN_DRAIN, pull=Pin.PULL_UP)
        self.__dataPin(1)
        #print(data)
        bits = []
        for a,b in data:
